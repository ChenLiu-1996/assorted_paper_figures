...
data_brute_force_math = {
    ...
    'colors': ['#FFF6CC', '#DDF3DE', '#AADCA9', '#8BCF8B', '#F6CFCB', '#E9A6A1', '#3775BA'],
    ...
    'hatch_styles': ['/', '\\', '', 'x'],
    'result': {
        'CoT Prompt': np.array([[16.9, 5.9, 70.0, 7.2],
                                [26.8, 3.6, 60.0, 9.6],
                                [27.6, 3.2, 59.2, 10.0],
                                [24.4, 4.0, 62.4, 9.2],
                                [31.2, 3.6, 55.6, 9.6],
        ...
        'Math Prompt': np.array([[12.6, 5.2, 74.8, 7.4],
                                 [27.2, 4.8, 59.6, 8.4],
                                 [25.6, 4.8, 61.2, 8.4],
                                 [24.4, 4.8, 62.4, 8.4],
                                 [28.4, 3.2, 58.4, 10.0],
        ...
        'Hint Prompt': np.array([[12.4, 5.1, 74.4, 8.1],
                                 [29.6, 4.4, 57.2, 8.8],
                                 [27.6, 2.8, 59.2, 10.4],
                                 [20.4, 5.2, 66.4, 8.0],
                                 [28.0, 3.2, 58.8, 10.0],
        ...
        'Math + Hint': np.array([[10.0, 6.1, 76.4, 7.4],
                                 [26.4, 4.0, 60.4, 9.2],
                                 [27.6, 3.2, 59.2, 10.0],
                                 [24.0, 4.8, 62.8, 8.4],
                                 [25.2, 2.8, 61.6, 10.4],
...
data_brute_force_logic = {
    ...
    'hatch_styles': ['/', '\\', '', 'x'],
    'result': {
        'CoT Prompt': np.array([[15.7, 3.2, 75.6, 5.5],
                                [18.0, 5.2, 72.0, 4.8],
                                [30.8, 3.2, 59.2, 6.8],
                                [23.2, 2.8, 66.8, 7.2],
                                [32.4, 3.6, 57.6, 6.4],
        ...
        'Math Prompt': np.array([[15.2, 5.5, 75.7, 3.7],
                                 [20.0, 4.4, 70.0, 5.6],
                                 [31.2, 4.0, 58.8, 6.0],
                                 [24.4, 4.0, 65.6, 6.0],
                                 [33.6, 3.6, 56.4, 6.4],
        ...
        'Hint Prompt': np.array([[14.3, 4.5, 75.8, 5.4],
                                 [15.6, 4.8, 74.4, 5.2],
                                 [30.4, 3.2, 59.6, 6.8],
                                 [25.2, 2.8, 64.8, 7.2],
                                 [27.6, 2.8, 62.4, 7.2],
        ...
        'Math + Hint': np.array([[13.0, 5.3, 76.8, 4.8],
                                 [20.0, 3.2, 70.0, 6.8],
                                 [32.0, 4.8, 58.0, 5.2],
                                 [19.6, 4.0, 70.4, 6.0],
                                 [26.0, 4.0, 64.0, 6.0],
